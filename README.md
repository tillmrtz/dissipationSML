...
# Variables used from ERA-5 reanalysis data: (https://cds.climate.copernicus.eu/datasets/reanalysis-era5-single-levels?tab=overview)
...
# Glider dives: (https://iop.apl.washington.edu/seaglider/index.php?mission=Faroes)
Data on server (url: „https://www.ncei.noaa.gov/data/oceans/glider/seaglider/uw/“)
