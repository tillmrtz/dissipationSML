...
def get_colormap(var: str):
    ...
    a default colormap (cmo.delta) is returned. Also return the log_scale attribute if it exists.
    ...
    if var in variable_dict:
        ...
        log_scale = variable_dict[var].get("log_scale", False)
    else:
        colormap = cmo.delta
    return colormap, log_scale